...
- En **Invitados** usa la columna **estado** que ya existe (confirmado / rechazado / leído / sin abrir) sin
  tocarla —o la crea con esas etiquetas si no hay— y agrega **recordatorio** (enlace de WhatsApp con el
  mensaje y el link personal, solo para "sin abrir" y "leído") en la primera columna libre, después de
  todo lo que haya.
